<template> 
    <div class="currency-item">
        ...
        <div class="item-icon">
            <img src="../assets/img/xlm.png" alt="Stellar">
            <!-- <h1 class="item-name">Stellar</h1> -->

            <h1 class="item-price">{{ cryptoCurrencyData.XLM.EUR.PRICE }}</h1>
        </div>
        ...
        <div class="item-info">
            <div class="row">
                <p>Open: {{ cryptoCurrencyData.XLM.EUR.OPEN24HOUR }} </p>
                <p>Change: {{ cryptoCurrencyData.XLM.EUR.CHANGEDAY }} </p>
            </div>
            <div class="row">
                <p>Low: {{ cryptoCurrencyData.XLM.EUR.LOW24HOUR }} </p>
                <p>High: {{ cryptoCurrencyData.XLM.EUR.HIGH24HOUR }} </p>
            </div>
        </div>
