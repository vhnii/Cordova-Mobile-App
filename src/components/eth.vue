<template> 
    <div class="currency-item">
        ...
        <div class="item-icon">
            ...
            <!-- <h1 class="item-name">Ethereum</h1> -->

            <h1 class="item-price">{{ stringFix(cryptoCurrencyData.ETH.EUR.PRICE) }}</h1>
        </div>
        ...
        <div class="item-info">
            <div class="row">
                <p>Open: {{ stringFix(cryptoCurrencyData.ETH.EUR.OPEN24HOUR) }} </p>
                <p>Change: {{ stringFix(cryptoCurrencyData.ETH.EUR.CHANGEDAY) }} </p>
            </div>
            <div class="row">
                <p>Low: {{ stringFix(cryptoCurrencyData.ETH.EUR.LOW24HOUR) }} </p>
                <p>High: {{ stringFix(cryptoCurrencyData.ETH.EUR.HIGH24HOUR) }} </p>
            </div>
        </div>
