<template> 
    <div class="currency-item">
        ...
        <div class="item-icon">
            <img src="../assets/img/xrp.png" alt="Ripple">
            <!-- <h1 class="item-name">Ripple</h1> -->

            <h1 class="item-price">{{ cryptoCurrencyData.XRP.EUR.PRICE }}</h1>
        </div>
        ...
        <div class="item-info">
            <div class="row">
                <p>Open: {{ cryptoCurrencyData.XRP.EUR.OPEN24HOUR }} </p>
                <p>Change: {{ cryptoCurrencyData.XRP.EUR.CHANGEDAY }} </p>
            </div>
            <div class="row">
                <p>Low: {{ cryptoCurrencyData.XRP.EUR.LOW24HOUR }} </p>
                <p>High: {{ cryptoCurrencyData.XRP.EUR.HIGH24HOUR }} </p>
            </div>
        </div>
