<template> 
    <div class="currency-item">
        ...
        <div class="item-icon">
            ...
            <!-- <h1 class="item-name">Bitcoin</h1> -->

            <h1 class="item-price">{{ stringFix(cryptoCurrencyData.BTC.EUR.PRICE) }}</h1>
        </div>
        ...
        <div class="item-info">
            <div class="row">
                <p>Open: {{ stringFix(cryptoCurrencyData.BTC.EUR.OPEN24HOUR) }} </p>
                <p>Change: {{ stringFix(cryptoCurrencyData.BTC.EUR.CHANGEDAY) }} </p>
            </div>
            <div class="row">
                <p>Low: {{ stringFix(cryptoCurrencyData.BTC.EUR.LOW24HOUR) }} </p>
                <p>High: {{ stringFix(cryptoCurrencyData.BTC.EUR.HIGH24HOUR) }} </p>
            </div>
        </div>
